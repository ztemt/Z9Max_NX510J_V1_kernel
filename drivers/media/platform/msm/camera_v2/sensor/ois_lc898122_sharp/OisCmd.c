...
static int8_t OIS_PHY_SWITCH=0;
...
unsigned char	RtnCen( unsigned char	UcCmdPar )
{
	...
	UcCmdSts	= EXE_END ;
       ...
       //ZTEMT-wangqiaoming::modify OIS drift problem, begin
	if ( OIS_PHY_SWITCH==0)
	{
		return UcCmdSts;
	}
	OIS_PHY_SWITCH=0;
	//GyrCon( OFF ) ;											// Gyro OFF
        //ZTEMT-wangqiaoming::modify OIS drift problem, end
...
void	OisEna( void )
{
	...
	//GyrCon( ON ) ; //ZTEMT-wangqiaoming::modify OIS drift problem
}
