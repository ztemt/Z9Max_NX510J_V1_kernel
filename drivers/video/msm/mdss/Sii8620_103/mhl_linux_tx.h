...
#if 1
#define GPIO_MHL_INT				942//138	/* W_INT */
#define GPIO_BB_RESET				936//140	/* P_BB_RST# */
#define GPIO_BB_FW_WAKE                   890
//#define GPIO_BB_POWER_1V0                14   //delete by liping

#define GPIO_BB_ID_SEL                        894
#else
uint8_t GPIO_MHL_INT;
uint8_t GPIO_BB_RESET;
uint8_t GPIO_BB_FW_WAKE;
uint8_t GPIO_BB_POWER_1V0;
uint8_t GPIO_BB_ID_SEL;
#endif
/*
