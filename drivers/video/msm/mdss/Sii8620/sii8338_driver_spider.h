...
//#ifndef _SII8338_DRIVER_H_
//#define _SII8338_DRIVER_H_
#ifndef _SII8338_DRIVER_SPIDER_H_
#define _SII8338_DRIVER_SPIDER_H_
...
#ifndef CONFIG_SII8338_RCP
#define CONFIG_SII8338_RCP		1
...
struct sii8338_data {
	struct sii8338_platform_data	*pdata;
...
//static struct sii8338_data *g_sii8338;
...
void spider_handle_msg(struct sii8338_spider_data *sii8338, 
						void *data, int state);
...
static int sii8338_msc_req_locked(struct sii8338_data *sii8338,
					struct msc_packet *msc_pkt);
static int sii8338_enqueue_msc_work(struct sii8338_data *sii8338, u8 command,
		u8 offset, u8 data_1, u8 data_2);
static struct device *sii8338_mhldev;
extern void mhl_hpd_handler(bool state);
static int sii8338_detection_callback(void);
static void sii8338_cancel_callback(void);
static u8 sii8338_tmds_control(struct sii8338_data *sii8338, bool enable);
static bool cbus_command_request(struct sii8338_data *sii8338,
				 enum cbus_command command,
				 u8 offset, u8 data);
static void cbus_command_response(struct sii8338_data *sii8338);
static irqreturn_t sii8338_irq_thread(int irq, void *data);

#ifdef CONFIG_SAMSUNG_MHL_9290
static int sii8338_30pin_init_for_9290(struct sii8338_data *sii8338);
#endif
...
#ifndef pr_debug
#define pr_debug(string,args...)	printk(KERN_INFO string,##args)
#endif
#ifndef dbg_enter
#define dbg_enter()			//SI_MDT_DEBUG_PRINT("spider debug enter\n")
#endif
#ifndef pr_warn
#define pr_warn(string,args...)		printk(KERN_INFO string,##args)
#endif
