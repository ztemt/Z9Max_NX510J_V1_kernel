...
//#define CONFIG_SPIDER_MHL_DEBUG
...
#endif
#ifdef MDT_SUPPORT
void spidermouse_enable(int dev_type);						// need an advance prototype to allow simulated
int spidermouse_disable(int dev_type);						//     hot-plug
#endif
#endif	/* _SPIDERMHL_H_ */
