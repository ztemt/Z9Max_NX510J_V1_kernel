...
typedef struct {
	...
	//detailed_timing_descriptor_t *cea_861_dtd_list;
	//size_t					num_cea_861_dtds;
	MHL3_hev_dtd_item_t		hev_dtd_payload;
	MHL3_hev_dtd_item_t		*hev_dtd_list;
	item_alloc_info_t		hev_dtd_info;
	MHL3_hev_vic_item_t		*hev_vic_list;
	item_alloc_info_t		hev_vic_info;
	MHL3_3d_dtd_item_t		*_3d_dtd_list;
	item_alloc_info_t		_3d_dtd_info;
	MHL3_3d_vic_item_t		*_3d_vic_list;
	item_alloc_info_t		_3d_vic_info;
...
void si_mhl_tx_process_3d_vic_burst(void *context,
								PMHL2_video_format_data_t pWriteBurstData);
void si_mhl_tx_process_3d_dtd_burst(void *context,
								PMHL2_video_format_data_t pWriteBurstData);
void si_mhl_tx_process_hev_vic_burst(edid_3d_data_p mhl_edid_3d_data,PMHL3_hev_vic_data_t p_write_burst_data);
...
bool si_mhl_tx_check_edid_header(edid_3d_data_p mhl_edid_3d_data, PEDID_block0_t p_EDID_block_0);
#endif //)
