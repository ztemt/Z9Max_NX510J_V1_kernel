...
uint8_t EDID_block_data_t [4*EDID_BLOCK_SIZE];
...
static void si_mhl_tx_prune_edid(edid_3d_data_p mhl_edid_3d_data)
{
	...
	*/
	memcpy(&EDID_block_data_t,&mhl_edid_3d_data->EDID_block_data,4*EDID_BLOCK_SIZE);

	DUMP_EDID_BLOCK(0,EDID_block_data_t,4*EDID_BLOCK_SIZE) 
