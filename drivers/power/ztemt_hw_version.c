...
static const struct hardware_id_map_st hardware_id_map[] = {
	{0,    300,  NX508J_HW_A, ZTE_GPIO_FLOAT,ZTE_GPIO_FLOAT,  ZTE_GPIO_FLOAT,"NX508JMB_A","wifi_samsung"},	//id_mv=0
	{300,  600,  NX508J_HW_B, ZTE_GPIO_FLOAT,ZTE_GPIO_FLOAT,  ZTE_GPIO_FLOAT,"NX508JMB_B","wifi_samsung"},  //id_mv=544
	{300,  600,  NX508J_HW_B, ZTE_GPIO_FLOAT,ZTE_GPIO_PULL_UP,ZTE_GPIO_FLOAT,"NX508JMB_B","wifi_epcos"},  //id_mv=544
	{600,  900,  NX508J_HW_C, ZTE_GPIO_FLOAT,ZTE_GPIO_FLOAT,  ZTE_GPIO_FLOAT,"NX508JMB_C","111"},  //id_mv=720
	{900,  1200, NX508J_HW_D, ZTE_GPIO_FLOAT,ZTE_GPIO_FLOAT,  ZTE_GPIO_FLOAT,"NX508JMB_D","111"},  //id_mv=1120
	{1200, 1500, NX508J_HW_E, ZTE_GPIO_FLOAT,ZTE_GPIO_FLOAT,  ZTE_GPIO_FLOAT,"NX508JMB_E","111"},	//id_mv=1475
	{1500, 1800, NX508J_HW_F, ZTE_GPIO_FLOAT,ZTE_GPIO_FLOAT,  ZTE_GPIO_FLOAT,"NX508JMB_F","111"},	//id_mv=1800
};
...
#ifdef CONFIG_ZTEMT_HW_VERSION_NX508J
