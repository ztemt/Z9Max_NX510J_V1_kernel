...
static struct mxt_platform_data *mxt_parse_dt(struct i2c_client *client)
{
	...
	*/
	...
	if (prop) {
		...
		keymap[T15_T97_KEY][0] = KEY_HOMEPAGE;//KEY_MENU;
		keymap[T15_T97_KEY][1] = KEY_BACK/*KEY_MENU*/;//KEY_BACK;
		keymap[T15_T97_KEY][2] = KEY_MENU/*KEY_HOMEPAGE*/;
